...
(function de_main_func_inner(scriptStorage, FormData, scrollTo, localData) {
	...
	var Lng = {
		cfg: {
			'hideBySpell': ['Ð¡Ð¿ÐµÐ»Ð»Ñ‹: ', 'Magic spells: '],
			'sortSpells': ['Ð¡Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ ÑÐ¿ÐµÐ»Ð»Ñ‹ Ð¸ ÑƒÐ´Ð°Ð»ÑÑ‚ÑŒ Ð´ÑƒÐ±Ð»Ð¸ÐºÐ°Ñ‚Ñ‹', 'Sort spells and remove duplicates'],
			'menuHiddBtn': ['Ð”Ð¾Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾Ðµ Ð¼ÐµÐ½ÑŽ Ð´Ð»Ñ ÐºÐ½Ð¾Ð¿Ð¾Ðº "Ð¡ÐºÑ€Ñ‹Ñ‚ÑŒ" ', 'Extra options for "Hide" buttons'],
			'hideRefPsts': ['Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¾Ñ‚Ð²ÐµÑ‚Ñ‹ Ð½Ð° ÑÐºÑ€Ñ‹Ñ‚Ñ‹Ðµ Ð¿Ð¾ÑÑ‚Ñ‹', 'Hide replies to hidden posts'],
			'delHiddPost': {
				sel: [['ÐžÑ‚ÐºÐ».', 'Ð’ÑÑ‘', 'Ð¢Ð¾Ð»ÑŒÐºÐ¾ Ð¿Ð¾ÑÑ‚Ñ‹', 'Ð¢Ð¾Ð»ÑŒÐºÐ¾ Ñ‚Ñ€ÐµÐ´Ñ‹'], ['Disable', 'All', 'Posts only', 'Threads only']],
				txt: ['Ð£Ð´Ð°Ð»ÑÑ‚ÑŒ ÑÐºÑ€Ñ‹Ñ‚Ð¾Ðµ', 'Remove placeholders']
			},

			'ajaxUpdThr': ['ÐÐ¿Ð´ÐµÐ¹Ñ‚ÐµÑ€ Ñ‚Ñ€ÐµÐ´Ð¾Ð² ', 'Threads updater '],
			'updThrDelay': ['(ÑÐµÐº)', '(sec)'],
			'updCount': ['ÐžÐ±Ñ€Ð°Ñ‚Ð½Ñ‹Ð¹ ÑÑ‡ÐµÑ‚Ñ‡Ð¸Ðº Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ñ Ñ‚Ñ€ÐµÐ´Ð°', 'Show countdown to thread update'],
			'favIcoBlink': ['ÐœÐ¸Ð³Ð°Ñ‚ÑŒ Ñ„Ð°Ð²Ð¸ÐºÐ¾Ð½Ð¾Ð¼ Ð¿Ñ€Ð¸ Ð½Ð¾Ð²Ñ‹Ñ… Ð¿Ð¾ÑÑ‚Ð°Ñ…', 'Blink the favicon on new posts'],
			'desktNotif': ['Ð£Ð²ÐµÐ´Ð¾Ð¼Ð»ÑÑ‚ÑŒ Ð¾ Ð½Ð¾Ð²Ñ‹Ñ… Ð¿Ð¾ÑÑ‚Ð°Ñ… Ð½Ð° Ñ€Ð°Ð±Ð¾Ñ‡ÐµÐ¼ ÑÑ‚Ð¾Ð»Ðµ', 'Desktop notifications for new posts'],
			'noErrInTitle': ['ÐÐµ Ð¿Ð¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ Ð½Ð¾Ð¼ÐµÑ€ Ð¾ÑˆÐ¸Ð±ÐºÐ¸ Ð² Ð·Ð°Ð³Ð¾Ð»Ð¾Ð²ÐºÐµ', 'Don\'t show error code in title'],
			'markNewPosts': ['Ð’Ñ‹Ð´ÐµÐ»ÑÑ‚ÑŒ Ñ†Ð²ÐµÑ‚Ð¾Ð¼ Ð½Ð¾Ð²Ñ‹Ðµ Ð¿Ð¾ÑÑ‚Ñ‹', 'Highlight new posts with color'],
			'useDobrAPI': ['dobrochan: Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÑŒ JSON API', 'dobrochan: use JSON API'],
			'markMyPosts': ['Ð’Ñ‹Ð´ÐµÐ»ÑÑ‚ÑŒ Ñ†Ð²ÐµÑ‚Ð¾Ð¼ Ð¼Ð¾Ð¸ Ð¿Ð¾ÑÑ‚Ñ‹', 'Highlight my own posts'],
			'hideReplies': ['ÐŸÐ¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ð¾Ð¿-Ð¿Ð¾ÑÑ‚Ñ‹ Ð² ÑÐ¿Ð¸ÑÐºÐµ Ñ‚Ñ€ÐµÐ´Ð¾Ð²*', 'Show only OP in threads list*'],
			'expandTrunc': ['ÐÐ²Ñ‚Ð¾Ñ€Ð°Ð·Ð²Ð¾Ñ€Ð¾Ñ‚ ÑÐ¾ÐºÑ€Ð°Ñ‰ÐµÐ½Ð½Ñ‹Ñ… Ð¿Ð¾ÑÑ‚Ð¾Ð²*', 'Autoexpand truncated posts*'],
			'updThrBtns': ['ÐšÐ½Ð¾Ð¿ÐºÐ¸ "ÐŸÐ¾Ð»ÑƒÑ‡Ð¸Ñ‚ÑŒ Ð½Ð¾Ð²Ñ‹Ðµ Ð¿Ð¾ÑÑ‚Ñ‹" Ð² ÑÐ¿Ð¸ÑÐºÐµ Ñ‚Ñ€ÐµÐ´Ð¾Ð²', 'Show "Buscar nuevo post" buttons in threads list'],
			'showHideBtn': ['ÐšÐ½Ð¾Ð¿ÐºÐ¸ "Ð¡ÐºÑ€Ñ‹Ñ‚ÑŒ" ', 'Show "Hide" buttons '],
			'showRepBtn': ['ÐšÐ½Ð¾Ð¿ÐºÐ¸ "Ð‘Ñ‹ÑÑ‚Ñ€Ñ‹Ð¹ Ð¾Ñ‚Ð²ÐµÑ‚"', 'Show "Quick reply" buttons'],
			'postBtnsCSS': {
				sel: [['Ð£Ð¿Ñ€Ð¾Ñ‰ÐµÐ½Ð½Ñ‹Ðµ', 'Ð¡ÐµÑ€Ñ‹Ð¹ Ð³Ñ€Ð°Ð´Ð¸ÐµÐ½Ñ‚', 'ÐÐ°ÑÑ‚Ñ€Ð°Ð¸Ð²Ð°ÐµÐ¼Ñ‹Ðµ'], ['Simple', 'Gradient grey', 'Custom']],
				txt: ['ÐšÐ½Ð¾Ð¿ÐºÐ¸ Ð¿Ð¾ÑÑ‚Ð¾Ð² ', 'Post buttons ']
			},
			'noSpoilers': {
				sel: [['ÐžÑ‚ÐºÐ».', 'Ð¡ÐµÑ€Ð¾Ðµ', 'Ð Ð¾Ð´Ð½Ð¾Ðµ'], ['Disable', 'Grey', 'Native']],
				txt: ['Ð Ð°ÑÐºÑ€Ñ‹Ñ‚Ð¸Ðµ Ñ‚ÐµÐºÑÑ‚Ð¾Ð²Ñ‹Ñ… ÑÐ¿Ð¾Ð¹Ð»ÐµÑ€Ð¾Ð²', 'Text spoilers expansion']
			},
			'noPostNames': ['Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¸Ð¼ÐµÐ½Ð° Ð² Ð¿Ð¾ÑÑ‚Ð°Ñ…', 'Hide poster names'],
			'widePosts': ['Ð Ð°ÑÑ‚ÑÐ³Ð¸Ð²Ð°Ñ‚ÑŒ Ð¿Ð¾ÑÑ‚Ñ‹ Ð¿Ð¾ ÑˆÐ¸Ñ€Ð¸Ð½Ðµ ÑÐºÑ€Ð°Ð½Ð°', 'Stretch posts to page width'],
			'hotKeys': ['Ð“Ð¾Ñ€ÑÑ‡Ð¸Ðµ ÐºÐ»Ð°Ð²Ð¸ÑˆÐ¸', 'Hotkeys'],
			'loadPages': ['ÐšÐ¾Ð»Ð¸Ñ‡ÐµÑÑ‚Ð²Ð¾ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†, Ð·Ð°Ð³Ñ€ÑƒÐ¶Ð°ÐµÐ¼Ñ‹Ñ… Ð¿Ð¾ F5', 'Number of pages that are loaded on F5 '],
			'correctTime': ['ÐšÐ¾Ñ€Ñ€ÐµÐºÑ†Ð¸Ñ Ð²Ñ€ÐµÐ¼ÐµÐ½Ð¸ Ð² Ð¿Ð¾ÑÑ‚Ð°Ñ…* ', 'Time correction in posts* '],
			'timeOffset': ['Ñ€Ð°Ð·Ð½Ð¸Ñ†Ð° (Ñ‡) ', 'time offset (h) '],
			'timePattern': ['Ð¨Ð°Ð±Ð»Ð¾Ð½ Ð¿Ð¾Ð¸ÑÐºÐ°', 'Search pattern'],
			'timeRPattern': ['Ð¨Ð°Ð±Ð»Ð¾Ð½ Ð·Ð°Ð¼ÐµÐ½Ñ‹', 'Replace pattern'],

			'expandImgs': {
				sel: [['ÐžÑ‚ÐºÐ».', 'Ð’ Ð¿Ð¾ÑÑ‚Ðµ', 'ÐŸÐ¾ Ñ†ÐµÐ½Ñ‚Ñ€Ñƒ'], ['Disable', 'In post', 'By center']],
				txt: ['Ð Ð°ÑÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸ Ð¿Ð¾ ÐºÐ»Ð¸ÐºÑƒ', 'Expand images on click']
			},
			'imgNavBtns': ['Ð”Ð¾Ð±Ð°Ð²Ð»ÑÑ‚ÑŒ ÐºÐ½Ð¾Ð¿ÐºÐ¸ Ð½Ð°Ð²Ð¸Ð³Ð°Ñ†Ð¸Ð¸ Ð¿Ð¾ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ°Ð¼', 'Add buttons to navigate images'],
			'resizeDPI': ['ÐžÑ‚Ð¾Ð±Ñ€Ð°Ð¶Ð°Ñ‚ÑŒ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸ Ð¿Ð¸ÐºÑÐµÐ»ÑŒ Ð² Ð¿Ð¸ÐºÑÐµÐ»ÑŒ', 'Don\'t upscale images on high DPI displays'],
			'resizeImgs': ['Ð£Ð¼ÐµÐ½ÑŒÑˆÐ°Ñ‚ÑŒ Ð² ÑÐºÑ€Ð°Ð½ Ð±Ð¾Ð»ÑŒÑˆÐ¸Ðµ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸', 'Resize large images to fit screen'],
			'minImgSize': ['ÐœÐ¸Ð½Ð¸Ð¼. Ñ€Ð°Ð·Ð¼ÐµÑ€ Ñ€Ð°ÑÐºÑ€Ñ‹Ñ‚Ñ‹Ñ… ÐºÐ°Ñ€Ñ‚Ð¸Ð½Ð¾Ðº (px)', 'Minimal size for expanded images (px)'],
			'zoomFactor': ['Ð§ÑƒÐ²ÑÑ‚Ð²Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾ÑÑ‚ÑŒ Ð·ÑƒÐ¼Ð° ÐºÐ°Ñ€Ñ‚Ð¸Ð½Ð¾Ðº [1-100%]', 'Images zoom sensibility [1-100%]'],
			'webmControl': ['ÐŸÐ¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ ÐºÐ¾Ð½Ñ‚Ñ€Ð¾Ð»-Ð±Ð°Ñ€ Ð´Ð»Ñ WebM', 'Show control bar for WebM'],
			'webmTitles': ['ÐŸÐ¾Ð»ÑƒÑ‡Ð°Ñ‚ÑŒ Ð½Ð°Ð·Ð²Ð°Ð½Ð¸Ñ WebM Ð¸Ð· Ð¼ÐµÑ‚Ð°Ð´Ð°Ð½Ð½Ñ‹Ñ…', 'Load titles from WebM metadata'],
			'webmVolume': ['Ð“Ñ€Ð¾Ð¼ÐºÐ¾ÑÑ‚ÑŒ WebM Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ [0-100%]', 'Default volume for WebM [0-100%]'],
			'minWebmWidth': ['ÐœÐ¸Ð½Ð¸Ð¼Ð°Ð»ÑŒÐ½Ð°Ñ ÑˆÐ¸Ñ€Ð¸Ð½Ð° WebM (px)', 'Minimal width for WebM (px)'],
			'preLoadImgs': ['ÐŸÑ€ÐµÐ´Ð²Ð°Ñ€Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾ Ð·Ð°Ð³Ñ€ÑƒÐ¶Ð°Ñ‚ÑŒ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸*', 'Preload images*'],
			'findImgFile': ['Ð Ð°ÑÐ¿Ð¾Ð·Ð½Ð°Ð²Ð°Ñ‚ÑŒ Ð²ÑÑ‚Ñ€Ð¾ÐµÐ½Ð½Ñ‹Ðµ Ñ„Ð°Ð¹Ð»Ñ‹ Ð² ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ°Ñ…*', 'Detect embedded files in images*'],
			'openImgs': {
				sel: [['ÐžÑ‚ÐºÐ».', 'Ð’ÑÐµ Ð¿Ð¾Ð´Ñ€ÑÐ´', 'Ð¢Ð¾Ð»ÑŒÐºÐ¾ GIF', 'ÐšÑ€Ð¾Ð¼Ðµ GIF'], ['Disable', 'All types', 'Only GIF', 'Non-GIF']],
				txt: ['Ð—Ð°Ð¼ÐµÐ½ÑÑ‚ÑŒ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸ Ð½Ð° Ð¾Ñ€Ð¸Ð³Ð¸Ð½Ð°Ð»Ñ‹*', 'Replace thumbnails with original images*']
			},
			'imgSrcBtns': ['Ð”Ð¾Ð±Ð°Ð²Ð»ÑÑ‚ÑŒ ÐºÐ½Ð¾Ð¿ÐºÐ¸ "ÐŸÐ¾Ð¸ÑÐº" Ð´Ð»Ñ ÐºÐ°Ñ€Ñ‚Ð¸Ð½Ð¾Ðº', 'Add "Search" buttons for images'],
			'delImgNames': ['Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¸Ð¼ÐµÐ½Ð° ÐºÐ°Ñ€Ñ‚Ð¸Ð½Ð¾Ðº', 'Hide filenames'],
			'maskVisib': ['ÐŸÑ€Ð¾Ð·Ñ€Ð°Ñ‡Ð½Ð¾ÑÑ‚ÑŒ Ð² Ñ€ÐµÐ¶Ð¸Ð¼Ðµ NSFW [0-100%]', 'Images opacity in NSFW mode [0-100%]'],

			'linksNavig': ['ÐÐ°Ð²Ð¸Ð³Ð°Ñ†Ð¸Ñ Ð¿Ð¾ÑÑ‚Ð¾Ð² Ð¿Ð¾ >>ÑÑÑ‹Ð»ÐºÐ°Ð¼* ', 'Posts navigation by >>links* '],
			'linksOver': ['ÐŸÐ¾ÑÐ²Ð»ÐµÐ½Ð¸Ðµ ', 'Appearance '],
			'linksOut': ['ÐŸÑ€Ð¾Ð¿Ð°Ð´Ð°Ð½Ð¸Ðµ (Ð¼Ñ)', 'Disappearance (ms)'],
			'markViewed': ['ÐŸÐ¾Ð¼ÐµÑ‡Ð°Ñ‚ÑŒ Ð¿Ñ€Ð¾ÑÐ¼Ð¾Ñ‚Ñ€ÐµÐ½Ð½Ñ‹Ðµ Ð¿Ð¾ÑÑ‚Ñ‹', 'Mark viewed posts'],
			'strikeHidd': ['Ð—Ð°Ñ‡ÐµÑ€ÐºÐ¸Ð²Ð°Ñ‚ÑŒ >>ÑÑÑ‹Ð»ÐºÐ¸ Ð½Ð° ÑÐºÑ€Ñ‹Ñ‚Ñ‹Ðµ Ð¿Ð¾ÑÑ‚Ñ‹', 'Strike >>links to hidden posts'],
			'removeHidd': ['Ð¢Ð°ÐºÐ¶Ðµ ÑƒÐ´Ð°Ð»ÑÑ‚ÑŒ Ð¸Ð· ÐºÐ°Ñ€Ñ‚Ñ‹ Ð¾Ñ‚Ð²ÐµÑ‚Ð¾Ð²', 'Also remove from reply maps'],
			'noNavigHidd': ['ÐÐµ Ð¾Ñ‚Ð¾Ð±Ñ€Ð°Ð¶Ð°Ñ‚ÑŒ Ð¿Ñ€ÐµÐ²ÑŒÑŽ Ð´Ð»Ñ ÑÐºÑ€Ñ‹Ñ‚Ñ‹Ñ… Ð¿Ð¾ÑÑ‚Ð¾Ð²', 'Don\'t show previews for hidden posts'],
			'markMyLinks': ['ÐŸÐ¾Ð¼ÐµÑ‡Ð°Ñ‚ÑŒ ÑÑÑ‹Ð»ÐºÐ¸ Ð½Ð° Ð¼Ð¾Ð¸ Ð¿Ð¾ÑÑ‚Ñ‹ ÐºÐ°Ðº (You)', 'Mark links to my posts with (You)'],
			'crossLinks': ['Ð—Ð°Ð¼ÐµÐ½ÑÑ‚ÑŒ http:// Ð½Ð° >>/b/ÑÑÑ‹Ð»ÐºÐ¸*', 'Replace http:// with >>/b/links*'],
			'decodeLinks': ['Ð”ÐµÐºÐ¾Ð´Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ %D0%A5%D1 Ð² ÑÑÑ‹Ð»ÐºÐ°Ñ…*', 'Decode %D0%A5%D1 in links*'],
			'insertNum': ['Ð’ÑÑ‚Ð°Ð²Ð»ÑÑ‚ÑŒ >>ÑÑÑ‹Ð»ÐºÑƒ Ð¿Ð¾ ÐºÐ»Ð¸ÐºÑƒ Ð½Ð° â„–Ð¿Ð¾ÑÑ‚Ð°*', 'Insert >>link on â„–postnumber click*'],
			'addOPLink': ['>>ÑÑÑ‹Ð»ÐºÐ° Ð¿Ñ€Ð¸ Ð¾Ñ‚Ð²ÐµÑ‚Ðµ Ð½Ð° Ð¾Ð¿-Ð¿Ð¾ÑÑ‚ Ð½Ð° Ð´Ð¾ÑÐºÐµ', 'Insert >>link when replying to OP on board'],
			'addImgs': ['Ð—Ð°Ð³Ñ€ÑƒÐ¶Ð°Ñ‚ÑŒ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸ Ðº jpg/png/gif ÑÑÑ‹Ð»ÐºÐ°Ð¼*', 'Load images for jpg/png/gif links*'],
			'addMP3': ['ÐŸÐ»ÐµÐµÑ€ Ðº mp3 ÑÑÑ‹Ð»ÐºÐ°Ð¼* ', 'Player for mp3 links* '],
			'addVocaroo': ['Ðº Vocaroo ÑÑÑ‹Ð»ÐºÐ°Ð¼*', 'for Vocaroo links*'],
			'addVimeo': ['Ð”Ð¾Ð±Ð°Ð²Ð»ÑÑ‚ÑŒ Ð¿Ð»ÐµÐµÑ€ Ðº Vimeo ÑÑÑ‹Ð»ÐºÐ°Ð¼*', 'Add player for Vimeo links*'],
			'addYouTube': {
				sel: [['ÐÐ¸Ñ‡ÐµÐ³Ð¾', 'ÐŸÐ»ÐµÐµÑ€ Ð¿Ð¾ ÐºÐ»Ð¸ÐºÑƒ', 'ÐÐ²Ñ‚Ð¾ Ð¿Ð»ÐµÐµÑ€', 'ÐŸÑ€ÐµÐ²ÑŒÑŽ+Ð¿Ð»ÐµÐµÑ€', 'Ð¢Ð¾Ð»ÑŒÐºÐ¾ Ð¿Ñ€ÐµÐ²ÑŒÑŽ'], ['Nothing', 'On click player', 'Auto player', 'Preview+player', 'Only preview']],
				txt: ['Ðº YouTube ÑÑÑ‹Ð»ÐºÐ°Ð¼* ', 'for YouTube links* ']
			},
			'YTubeType': {
				sel: [['Flash', 'HTML5'], ['Flash', 'HTML5']],
				txt: ['', '']
			},
			'YTubeTitles': ['Ð—Ð°Ð³Ñ€ÑƒÐ¶Ð°Ñ‚ÑŒ Ð½Ð°Ð·Ð²Ð°Ð½Ð¸Ñ Ðº YouTube ÑÑÑ‹Ð»ÐºÐ°Ð¼*', 'Load titles for YouTube links*'],
			'ytApiKey': ['ÐšÐ»ÑŽÑ‡ YT API*', 'YT API Key*'],

			'ajaxPosting': ['ÐžÑ‚Ð¿Ñ€Ð°Ð²ÐºÐ° Ð¿Ð¾ÑÑ‚Ð¾Ð² Ð±ÐµÐ· Ð¿ÐµÑ€ÐµÐ·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ¸*', 'Posting without refresh*'],
			'postSameImg': ['Ð’Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ÑÑ‚ÑŒ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²ÐºÐ¸ Ð¾Ð´Ð¸Ð½Ð°ÐºÐ¾Ð²Ñ‹Ñ… ÐºÐ°Ñ€Ñ‚Ð¸Ð½Ð¾Ðº', 'Ability to post duplicate images'],
			'removeEXIF': ['Ð£Ð´Ð°Ð»ÑÑ‚ÑŒ EXIF Ð¸Ð· JPEG ', 'Remove EXIF from JPEG '],
			'removeFName': ['ÐžÑ‡Ð¸Ñ‰Ð°Ñ‚ÑŒ Ð¸Ð¼Ñ Ñ„Ð°Ð¹Ð»Ð¾Ð²', 'Clear file names'],
			'sendErrNotif': ['ÐžÐ¿Ð¾Ð²ÐµÑ‰Ð°Ñ‚ÑŒ Ð² Ð·Ð°Ð³Ð¾Ð»Ð¾Ð²ÐºÐµ Ð¾Ð± Ð¾ÑˆÐ¸Ð±ÐºÐµ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²ÐºÐ¸', 'Inform in title about post send error'],
			'scrAfterRep': ['ÐŸÐµÑ€ÐµÐ¼ÐµÑ‰Ð°Ñ‚ÑŒÑÑ Ð² ÐºÐ¾Ð½ÐµÑ† Ñ‚Ñ€ÐµÐ´Ð° Ð¿Ð¾ÑÐ»Ðµ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²ÐºÐ¸', 'Scroll to bottom after reply'],
			'fileInputs': {
				sel: [['ÐžÑ‚ÐºÐ».', 'Ð£Ð¿Ñ€Ð¾Ñ‰.', 'ÐŸÑ€ÐµÐ²ÑŒÑŽ'], ['Disable', 'Simple', 'Preview']],
				txt: ['Ð£Ð»ÑƒÑ‡ÑˆÐµÐ½Ð½Ð¾Ðµ Ð¿Ð¾Ð»Ðµ Ð´Ð¾Ð±Ð°Ð²Ð»ÐµÐ½Ð¸Ñ Ñ„Ð°Ð¹Ð»Ð¾Ð²', 'Enhanced file attachment field']
			},
			'addPostForm': {
				sel: [['Ð¡Ð²ÐµÑ€Ñ…Ñƒ', 'Ð’Ð½Ð¸Ð·Ñƒ', 'Ð¡ÐºÑ€Ñ‹Ñ‚Ð°Ñ'], ['At top', 'At bottom', 'Hidden']],
				txt: ['Ð¤Ð¾Ñ€Ð¼Ð° Ð¾Ñ‚Ð²ÐµÑ‚Ð° Ð² Ñ‚Ñ€ÐµÐ´Ðµ', 'Reply form display in thread']
			},
			'spacedQuote': ['Ð’ÑÑ‚Ð°Ð²Ð»ÑÑ‚ÑŒ Ð¿Ñ€Ð¾Ð±ÐµÐ» Ð¿Ñ€Ð¸ Ñ†Ð¸Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ð¸ "> "', 'Insert a space when quoting "> "'],
			'favOnReply': ['Ð”Ð¾Ð±Ð°Ð²Ð»ÑÑ‚ÑŒ Ñ‚Ñ€ÐµÐ´ Ð² "Ð˜Ð·Ð±Ñ€Ð°Ð½Ð½Ð¾Ðµ" Ð¿Ð¾ÑÐ»Ðµ Ð¾Ñ‚Ð²ÐµÑ‚Ð°', 'Add thread to "Favorites" after reply'],
			'warnSubjTrip': ['ÐžÐ¿Ð¾Ð²ÐµÑ‰Ð°Ñ‚ÑŒ Ð¾ Ñ‚Ñ€Ð¸Ð¿ÐºÐ¾Ð´Ðµ Ð² Ð¿Ð¾Ð»Ðµ "Ð¢ÐµÐ¼Ð°"', 'Warn about a tripcode in "Subject" field'],
			'addSageBtn': ['ÐšÐ½Ð¾Ð¿ÐºÐ° Sage Ð²Ð¼ÐµÑÑ‚Ð¾ Ð¿Ð¾Ð»Ñ "Email" ', 'Replace "Email" with Sage button '],
			'saveSage': ['ÐŸÐ¾Ð¼Ð½Ð¸Ñ‚ÑŒ ÑÐ°Ð¶Ñƒ', 'Remember sage'],
			'cap4chanAlt': ['4chan: Ð°Ð»ÑŒÑ‚ÐµÑ€Ð½Ð°Ñ‚Ð¸Ð²Ð½Ð°Ñ ÐºÐ°Ð¿Ñ‡Ð°*', '4chan: use alternative captcha*'],
			'capUpdTime': ['Ð˜Ð½Ñ‚ÐµÑ€Ð²Ð°Ð» Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ñ ÐºÐ°Ð¿Ñ‡Ð¸ (ÑÐµÐº)', 'Captcha update interval (sec)'],
			'captchaLang': {
				sel: [['ÐžÑ‚ÐºÐ».', 'Eng', 'Rus'], ['Disable', 'Eng', 'Rus']],
				txt: ['ÐŸÑ€Ð¸Ð½ÑƒÐ´Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ñ‹Ð¹ ÑÐ·Ñ‹Ðº Ð²Ð²Ð¾Ð´Ð° ÐºÐ°Ð¿Ñ‡Ð¸', 'Forced captcha input language']
			},
			'addTextBtns': {
				sel: [['ÐžÑ‚ÐºÐ».', 'Ð“Ñ€Ð°Ñ„Ð¸Ñ‡.', 'Ð£Ð¿Ñ€Ð¾Ñ‰.', 'Ð¡Ñ‚Ð°Ð½Ð´Ð°Ñ€Ñ‚.'], ['Disable', 'As images', 'As text', 'Standard']],
				txt: ['ÐšÐ½Ð¾Ð¿ÐºÐ¸ Ñ€Ð°Ð·Ð¼ÐµÑ‚ÐºÐ¸ Ñ‚ÐµÐºÑÑ‚Ð° ', 'Text markup buttons ']
			},
			'txtBtnsLoc': ['Ð’Ð½Ð¸Ð·Ñƒ', 'At bottom'],
			'userPassw': ['ÐŸÐ¾ÑÑ‚Ð¾ÑÐ½Ð½Ñ‹Ð¹ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ', 'Fixed password'],
			'userName': ['ÐŸÐ¾ÑÑ‚Ð¾ÑÐ½Ð½Ð¾Ðµ Ð¸Ð¼Ñ', 'Fixed name'],
			'noBoardRule': ['ÐŸÑ€Ð°Ð²Ð¸Ð»Ð° ', 'Rules '],
			'noPassword': ['ÐŸÐ°Ñ€Ð¾Ð»ÑŒ ', 'Password '],
			'noName': ['Ð˜Ð¼Ñ ', 'Name '],
			'noSubj': ['Ð¢ÐµÐ¼Ñƒ', 'Subject'],
			...
			'scriptStyle': {
				...
				txt: ['Ð¡Ñ‚Ð¸Ð»ÑŒ Dollchan', 'Dollchan style']
			},
			'userCSS': ['ÐŸÐ¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»ÑŒÑÐºÐ¸Ð¹ CSS', 'User CSS'],
			'panelCounter': {
				sel: [['ÐžÑ‚ÐºÐ».', 'Ð’ÑÐµ Ð¿Ð¾ÑÑ‚Ñ‹', 'Ð‘ÐµÐ· ÑÐºÑ€Ñ‹Ñ‚Ñ‹Ñ…'], ['Disabled', 'All posts', 'Except hidden']],
				txt: ['Ð¡Ñ‡ÐµÑ‚Ñ‡Ð¸Ðº Ð¿Ð¾ÑÑ‚Ð¾Ð²/ÐºÐ°Ñ€Ñ‚Ð¸Ð½Ð¾Ðº Ð½Ð° Ð¿Ð°Ð½ÐµÐ»Ð¸', 'Panel counter for posts/images']
			},
			'rePageTitle': ['ÐÐ°Ð·Ð²Ð°Ð½Ð¸Ðµ Ñ‚Ñ€ÐµÐ´Ð° Ð² Ð·Ð°Ð³Ð¾Ð»Ð¾Ð²ÐºÐµ Ð²ÐºÐ»Ð°Ð´ÐºÐ¸*', 'Show thread title in the page tab*'],
			'animation': ['CSS3 Ð°Ð½Ð¸Ð¼Ð°Ñ†Ð¸Ñ', 'CSS3 animation'],
			'closePopups': ['ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ¸ Ð·Ð°ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ ÑƒÐ²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ñ', 'Close popups automatically'],
			'inftyScroll': ['Ð‘ÐµÑÐºÐ¾Ð½ÐµÑ‡Ð½Ð°Ñ Ð¿Ñ€Ð¾ÐºÑ€ÑƒÑ‚ÐºÐ° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†', 'Infinite scrolling for pages'],
			'scrollToTop': ['Ð’ÑÐµÐ³Ð´Ð° ÑÐºÑ€Ð¾Ð»Ð»Ð¸Ñ‚ÑŒ Ð² Ñ‚Ð¾Ð¿ Ð½Ð° Ð´Ð¾ÑÐºÐµ', 'Always scroll to top in the threads list'],
			'updScript': ['ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ¸ Ð¿Ñ€Ð¾Ð²ÐµÑ€ÑÑ‚ÑŒ Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ñ', 'Auto check for Dollchan updates'],
			'scrUpdIntrv': {
				sel: [['ÐšÐ°Ð¶Ð´Ñ‹Ð¹ Ð´ÐµÐ½ÑŒ', 'ÐšÐ°Ð¶Ð´Ñ‹Ðµ 2 Ð´Ð½Ñ', 'ÐšÐ°Ð¶Ð´ÑƒÑŽ Ð½ÐµÐ´ÐµÐ»ÑŽ', 'ÐšÐ°Ð¶Ð´Ñ‹Ðµ 2 Ð½ÐµÐ´ÐµÐ»Ð¸', 'ÐšÐ°Ð¶Ð´Ñ‹Ð¹ Ð¼ÐµÑÑÑ†'], ['Every day', 'Every 2 days', 'Every week', 'Every 2 weeks', 'Every month']],
				txt: ['', '']
			},
			'excludeList': ['ÐÐµ Ð·Ð°Ð¿ÑƒÑÐºÐ°Ñ‚ÑŒ Dollchan Ð½Ð°:', 'Prevent Dollchan launch on:'],
			'turnOff': ['Ð’ÐºÐ»ÑŽÑ‡Ð°Ñ‚ÑŒ Dollchan Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ð½Ð° ÑÑ‚Ð¾Ð¼ ÑÐ°Ð¹Ñ‚Ðµ', 'Enable Dollchan only on this site'],
		...
		txtBtn: [['Ð–Ð¸Ñ€Ð½Ñ‹Ð¹', 'Bold'], ['ÐÐ°ÐºÐ»Ð¾Ð½Ð½Ñ‹Ð¹', 'Italic'], ['ÐŸÐ¾Ð´Ñ‡ÐµÑ€ÐºÐ½ÑƒÑ‚Ñ‹Ð¹', 'Underlined'], ['Ð—Ð°Ñ‡ÐµÑ€ÐºÐ½ÑƒÑ‚Ñ‹Ð¹', 'Strike'], ['Ð¡Ð¿Ð¾Ð¹Ð»ÐµÑ€', 'Spoiler'], ['ÐšÐ¾Ð´', 'Code'], ['Ð’ÐµÑ€Ñ…Ð½Ð¸Ð¹ Ð¸Ð½Ð´ÐµÐºÑ', 'Superscript'], ['ÐÐ¸Ð¶Ð½Ð¸Ð¹ Ð¸Ð½Ð´ÐµÐºÑ', 'Subscript'], ['Ð¦Ð¸Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð²Ñ‹Ð´ÐµÐ»ÐµÐ½Ð½Ð¾Ðµ', 'Quote selected']],

		cfgTab: {
			'filters': ['Ð¤Ð¸Ð»ÑŒÑ‚Ñ€Ñ‹', 'Filters'],
			'posts': ['ÐŸÐ¾ÑÑ‚Ñ‹', 'Posts'],
			'images': ['ÐšÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸', 'Images'],
			'links': ['Ð¡ÑÑ‹Ð»ÐºÐ¸', 'Links'],
			'form': ['Ð¤Ð¾Ñ€Ð¼Ð°', 'Form'],
			'common': ['ÐžÐ±Ñ‰ÐµÐµ', 'Common'],
			'info': ['Ð˜Ð½Ñ„Ð¾', 'Info']
		},

		panelBtn: {
			'attach': ['ÐŸÑ€Ð¸ÐºÑ€ÐµÐ¿Ð¸Ñ‚ÑŒ/ÐžÑ‚ÐºÑ€ÐµÐ¿Ð¸Ñ‚ÑŒ Ð¿Ð°Ð½ÐµÐ»ÑŒ', 'Attach/Detach panel'],
			'cfg': ['ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸', 'Settings'],
			'hid': ['Ð¡ÐºÑ€Ñ‹Ñ‚Ð¾Ðµ', 'Hidden'],
			'fav': ['Ð˜Ð·Ð±Ñ€Ð°Ð½Ð½Ð¾Ðµ', 'Favorites'],
			'vid': ['Ð’Ð¸Ð´ÐµÐ¾ ÑÑÑ‹Ð»ÐºÐ¸', 'Video links'],
			'refresh': ['ÐžÐ±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ', 'Refresh'],
			'goback': ['ÐÐ°Ð·Ð°Ð´ Ð½Ð° Ð´Ð¾ÑÐºÑƒ', 'Return to board'],
			'gonext': ['ÐÐ° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñƒ %s', 'Go to page %s'],
			'goup': ['Ð’ Ð½Ð°Ñ‡Ð°Ð»Ð¾ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹', 'Scroll to top'],
			'godown': ['Ð’ ÐºÐ¾Ð½ÐµÑ† ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹', 'Scroll to bottom'],
			'expimg': ['Ð Ð°ÑÐºÑ€Ñ‹Ñ‚ÑŒ Ð²ÑÐµ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸', 'Expand all images'],
			'preimg': ['ÐŸÑ€ÐµÐ´Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ° ÐºÐ°Ñ€Ñ‚Ð¸Ð½Ð¾Ðº&#13;([Ctrl+Click] Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ð´Ð»Ñ Ð½Ð¾Ð²Ñ‹Ñ… Ð¿Ð¾ÑÑ‚Ð¾Ð²)', 'Preload images&#13;([Ctrl+Click] for new posts only)'],
			'maskimg': ['Ð ÐµÐ¶Ð¸Ð¼ NSFW', 'NSFW mode'],
			'upd-on': ['Ð’Ñ‹ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð°Ð²Ñ‚Ð¾Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ Ñ‚Ñ€ÐµÐ´Ð°', 'Disable thread autoupdate'],
			'upd-off': ['Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð°Ð²Ñ‚Ð¾Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ Ñ‚Ñ€ÐµÐ´Ð°', 'Enable thread autoupdate'],
			'audio-off': ['Ð—Ð²ÑƒÐºÐ¾Ð²Ð¾Ðµ Ð¾Ð¿Ð¾Ð²ÐµÑ‰ÐµÐ½Ð¸Ðµ Ð¾ Ð½Ð¾Ð²Ñ‹Ñ… Ð¿Ð¾ÑÑ‚Ð°Ñ…', 'Sound notification about new posts'],
			'catalog': ['ÐŸÐµÑ€ÐµÐ¹Ñ‚Ð¸ Ð² ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³', 'Go to catalog'],
			'pcount': ['ÐŸÐ¾ÑÑ‚Ð¾Ð² Ð² Ñ‚Ñ€ÐµÐ´Ðµ', 'Posts in thread'],
			'pcountNotHid': ['ÐŸÐ¾ÑÑ‚Ð¾Ð² Ð² Ñ‚Ñ€ÐµÐ´Ðµ (Ð±ÐµÐ· ÑÐºÑ€Ñ‹Ñ‚Ñ‹Ñ…)', 'Posts in thread (without hidden)'],
			'imglen': ['ÐšÐ°Ñ€Ñ‚Ð¸Ð½Ð¾Ðº Ð² Ñ‚Ñ€ÐµÐ´Ðµ', 'Images in thread'],
			'posters': ['ÐŸÐ¾ÑÑ‚ÑÑ‰Ð¸Ñ… Ð² Ñ‚Ñ€ÐµÐ´Ðµ', 'Posters in thread'],
			'savethr': ['Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ð½Ð° Ð´Ð¸ÑÐº', 'Save to disk'],
			'enable': ['Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ/Ð²Ñ‹ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Dollchan', 'Turn on/off the Dollchan']
		},

		selHiderMenu: {
			'sel': ['Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð²Ñ‹Ð´ÐµÐ»ÐµÐ½Ð½Ð¾Ðµ', 'Hide selected text'],
			'name': ['Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¸Ð¼Ñ', 'Hide name'],
			'trip': ['Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ñ‚Ñ€Ð¸Ð¿ÐºÐ¾Ð´', 'Hide with tripcode'],
			'img': ['Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¿Ð¾ Ñ€Ð°Ð·Ð¼ÐµÑ€Ñƒ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸', 'Hide by image size'],
			'imgn': ['Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¿Ð¾ Ð¸Ð¼ÐµÐ½Ð¸ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸', 'Hide by image name'],
			'ihash': ['Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¿Ð¾ ÑÑ…Ð¾Ð¶ÐµÐ¹ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐµ', 'Hide by similar image'],
			'noimg': ['Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð±ÐµÐ· ÐºÐ°Ñ€Ñ‚Ð¸Ð½Ð¾Ðº', 'Hide without images'],
			'notext': ['Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð±ÐµÐ· Ñ‚ÐµÐºÑÑ‚Ð°', 'Hide without text'],
			'text': ['Ð¡ÐºÑ€Ñ‹Ñ‚ÑŒ ÑÑ…Ð¾Ð¶Ð¸Ð¹ Ñ‚ÐµÐºÑÑ‚', 'Hide similar text'],
			'refs': ['Ð¡ÐºÑ€Ñ‹Ñ‚ÑŒ Ñ Ð¾Ñ‚Ð²ÐµÑ‚Ð°Ð¼Ð¸', 'Hide with answers']
		},
		selExpandThr: [['+10 Ð¿Ð¾ÑÑ‚Ð¾Ð²', 'ÐŸÐ¾ÑÐ»ÐµÐ´Ð½Ð¸Ðµ 30', 'ÐŸÐ¾ÑÐ»ÐµÐ´Ð½Ð¸Ðµ 50', 'ÐŸÐ¾ÑÐ»ÐµÐ´Ð½Ð¸Ðµ 100', 'Ð’ÐµÑÑŒ Ñ‚Ñ€ÐµÐ´'], ['+10 posts', 'Last 30 posts', 'Last 50 posts', 'Last 100 posts', 'Entire thread']],
		selAjaxPages: [['1 ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°', '2 ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹', '3 ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹', '4 ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹', '5 ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†'], ['1 page', '2 pages', '3 pages', '4 pages', '5 pages']],
		selSaveThr: [['Ð¡ÐºÐ°Ñ‡Ð°Ñ‚ÑŒ Ð²ÐµÑÑŒ Ñ‚Ñ€ÐµÐ´', 'Ð¡ÐºÐ°Ñ‡Ð°Ñ‚ÑŒ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸'], ['Download thread', 'Download images']],
		selAudioNotif: [['ÐšÐ°Ð¶Ð´Ñ‹Ðµ 30 ÑÐµÐº.', 'ÐšÐ°Ð¶Ð´ÑƒÑŽ Ð¼Ð¸Ð½ÑƒÑ‚Ñƒ', 'ÐšÐ°Ð¶Ð´Ñ‹Ðµ 2 Ð¼Ð¸Ð½.', 'ÐšÐ°Ð¶Ð´Ñ‹Ðµ 5 Ð¼Ð¸Ð½.'], ['Every 30 sec.', 'Every minute', 'Every 2 min.', 'Every 5 min.']],

		hotKeyEdit: [['%l%i24 â€“ Ð¿Ñ€ÐµÐ´Ñ‹Ð´ÑƒÑ‰Ð°Ñ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°/ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ°%/l', '%l%i217 â€“ ÑÐ»ÐµÐ´ÑƒÑŽÑ‰Ð°Ñ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°/ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ°%/l', '%l%i21 â€“ Ñ‚Ñ€ÐµÐ´ (Ð½Ð° Ð´Ð¾ÑÐºÐµ)/Ð¿Ð¾ÑÑ‚ (Ð² Ñ‚Ñ€ÐµÐ´Ðµ) Ð½Ð¸Ð¶Ðµ%/l', '%l%i20 â€“ Ñ‚Ñ€ÐµÐ´ (Ð½Ð° Ð´Ð¾ÑÐºÐµ)/Ð¿Ð¾ÑÑ‚ (Ð² Ñ‚Ñ€ÐµÐ´Ðµ) Ð²Ñ‹ÑˆÐµ%/l', '%l%i31 â€“ Ð¿Ð¾ÑÑ‚ (Ð½Ð° Ð´Ð¾ÑÐºÐµ) Ð½Ð¸Ð¶Ðµ%/l', '%l%i30 â€“ Ð¿Ð¾ÑÑ‚ (Ð½Ð° Ð´Ð¾ÑÐºÐµ) Ð²Ñ‹ÑˆÐµ%/l', '%l%i23 â€“ ÑÐºÑ€Ñ‹Ñ‚ÑŒ Ð¿Ð¾ÑÑ‚/Ñ‚Ñ€ÐµÐ´%/l', '%l%i32 â€“ Ð¿ÐµÑ€ÐµÐ¹Ñ‚Ð¸ Ð² Ñ‚Ñ€ÐµÐ´%/l', '%l%i33 â€“ Ñ€Ð°Ð·Ð²ÐµÑ€Ð½ÑƒÑ‚ÑŒ Ñ‚Ñ€ÐµÐ´%/l', '%l%i211 â€“ Ñ€Ð°ÑÐºÑ€Ñ‹Ñ‚ÑŒ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÑƒ Ð² Ð¿Ð¾ÑÑ‚Ðµ%/l', '%l%i22 â€“ Ð±Ñ‹ÑÑ‚Ñ€Ñ‹Ð¹ Ð¾Ñ‚Ð²ÐµÑ‚%/l', '%l%i25t â€“ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ Ð¿Ð¾ÑÑ‚%/l', '%l%i210 â€“ Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚ÑŒ/Ð·Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ "ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸"%/l', '%l%i26 â€“ Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚ÑŒ/Ð·Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ "Ð˜Ð·Ð±Ñ€Ð°Ð½Ð½Ð¾Ðµ"%/l', '%l%i27 â€“ Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚ÑŒ/Ð·Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ "Ð¡ÐºÑ€Ñ‹Ñ‚Ð¾Ðµ"%/l', '%l%i218 â€“ Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚ÑŒ/Ð·Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ "Ð’Ð¸Ð´ÐµÐ¾"%/l', '%l%i28 â€“ Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚ÑŒ/Ð·Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ Ð¿Ð°Ð½ÐµÐ»ÑŒ%/l', '%l%i29 â€“ Ð²ÐºÐ»./Ð²Ñ‹ÐºÐ». Ñ€ÐµÐ¶Ð¸Ð¼ NSFW%/l', '%l%i40 â€“ Ð¾Ð±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ Ñ‚Ñ€ÐµÐ´ (Ð² Ñ‚Ñ€ÐµÐ´Ðµ)%/l', '%l%i212t â€“ Ð¶Ð¸Ñ€Ð½Ñ‹Ð¹%/l', '%l%i213t â€“ ÐºÑƒÑ€ÑÐ¸Ð²%/l', '%l%i214t â€“ Ð·Ð°Ñ‡ÐµÑ€ÐºÐ½ÑƒÑ‚Ñ‹Ð¹%/l', '%l%i215t â€“ ÑÐ¿Ð¾Ð¹Ð»ÐµÑ€%/l', '%l%i216t â€“ ÐºÐ¾Ð´%/l'], ['%l%i24 â€“ previous page/image%/l', '%l%i217 â€“ next page/image%/l', '%l%i21 â€“ thread (on board)/post (in thread) below%/l', '%l%i20 â€“ thread (on board)/post (in thread) above%/l', '%l%i31 â€“ on board post below%/l', '%l%i30 â€“ on board post above%/l', '%l%i23 â€“ hide post/thread%/l', '%l%i32 â€“ go to thread%/l', '%l%i33 â€“ expand thread%/l', '%l%i211 â€“ expand post\'s images%/l', '%l%i22 â€“ quick reply%/l', '%l%i25t â€“ send post%/l', '%l%i210 â€“ open/close "Settings"%/l', '%l%i26 â€“ open/close "Favorites"%/l', '%l%i27 â€“ open/close "Hidden"%/l', '%l%i218 â€“ open/close "Videos"%/l', '%l%i28 â€“ open/close main panel%/l', '%l%i29 â€“ toggle NSFW mode%/l', '%l%i40 â€“ update thread%/l', '%l%i212t â€“ bold%/l', '%l%i213t â€“ italic%/l', '%l%i214t â€“ strike%/l', '%l%i215t â€“ spoiler%/l', '%l%i216t â€“ code%/l']],

		month: [['ÑÐ½Ð²', 'Ñ„ÐµÐ²', 'Ð¼Ð°Ñ€', 'Ð°Ð¿Ñ€', 'Ð¼Ð°Ñ', 'Ð¸ÑŽÐ½', 'Ð¸ÑŽÐ»', 'Ð°Ð²Ð³', 'ÑÐµÐ½', 'Ð¾ÐºÑ‚', 'Ð½Ð¾Ñ', 'Ð´ÐµÐº'], ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']],
		fullMonth: [['ÑÐ½Ð²Ð°Ñ€Ñ', 'Ñ„ÐµÐ²Ñ€Ð°Ð»Ñ', 'Ð¼Ð°Ñ€Ñ‚Ð°', 'Ð°Ð¿Ñ€ÐµÐ»Ñ', 'Ð¼Ð°Ñ', 'Ð¸ÑŽÐ½Ñ', 'Ð¸ÑŽÐ»Ñ', 'Ð°Ð²Ð³ÑƒÑÑ‚Ð°', 'ÑÐµÐ½Ñ‚ÑÐ±Ñ€Ñ', 'Ð¾ÐºÑ‚ÑÐ±Ñ€Ñ', 'Ð½Ð¾ÑÐ±Ñ€Ñ', 'Ð´ÐµÐºÐ°Ð±Ñ€Ñ'], ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']],
		week: [['Ð’ÑÐº', 'ÐŸÐ½Ð´', 'Ð’Ñ‚Ñ€', 'Ð¡Ñ€Ð´', 'Ð§Ñ‚Ð²', 'ÐŸÑ‚Ð½', 'Ð¡Ð±Ñ‚'], ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']],

		editor: {
			cfg: ['Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ Ð½Ð°ÑÑ‚Ñ€Ð¾ÐµÐº:', 'Edit settings:'],
			hidden: ['Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ ÑÐºÑ€Ñ‹Ñ‚Ñ‹Ñ… Ñ‚Ñ€ÐµÐ´Ð¾Ð²:', 'Edit hidden threads:'],
			favor: ['Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ Ð¸Ð·Ð±Ñ€Ð°Ð½Ð½Ð¾Ð³Ð¾:', 'Edit favorites:'],
			css: ['Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ CSS', 'Edit CSS']
		},

		newPost: [[' Ð½Ð¾Ð²Ñ‹Ð¹ Ð¿Ð¾ÑÑ‚', ' Ð½Ð¾Ð²Ñ‹Ñ… Ð¿Ð¾ÑÑ‚Ð°', ' Ð½Ð¾Ð²Ñ‹Ñ… Ð¿Ð¾ÑÑ‚Ð¾Ð²', '. ÐŸÐ¾ÑÐ»ÐµÐ´Ð½Ð¸Ð¹:'], [' new post', ' new posts', ' new posts', '. Latest: ']],

		name: ['Ð˜Ð¼Ñ', 'Name'],
		subj: ['Ð¢ÐµÐ¼Ð°', 'Subject'],
		mail: ['Email', 'Email'],
		cap: ['ÐšÐ°Ð¿Ñ‡Ð°', 'Captcha'],
		video: ['Ð’Ð¸Ð´ÐµÐ¾', 'Video'],
		add: ['Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ', 'Add'],
		apply: ['ÐŸÑ€Ð¸Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ', 'Apply'],
		cancel: ['ÐžÑ‚Ð¼ÐµÐ½Ð°', 'Cancel'],
		clear: ['ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ', 'Clear'],
		refresh: ['ÐžÐ±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ', 'Refresh'],
		load: ['Ð—Ð°Ð³Ñ€ÑƒÐ·Ð¸Ñ‚ÑŒ', 'Load'],
		save: ['Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ', 'Save'],
		edit: ['ÐŸÑ€Ð°Ð²ÐºÐ°', 'Edit'],
		file: ['Ð¤Ð°Ð¹Ð»', 'File'],
		global: ['Ð“Ð»Ð¾Ð±Ð°Ð»ÑŒÐ½Ñ‹Ðµ', 'Global'],
		reset: ['Ð¡Ð±Ñ€Ð¾Ñ', 'Reset'],
		remove: ['Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ', 'Remove'],
		info: ['Ð˜Ð½Ñ„Ð¾', 'Info'],
		undo: ['ÐžÑ‚Ð¼ÐµÐ½Ð°', 'Undo'],
		change: ['Ð¡Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ', 'Change'],
		reply: ['ÐžÑ‚Ð²ÐµÑ‚', 'Reply'],
		loading: ['Ð—Ð°Ð³Ñ€ÑƒÐ·ÐºÐ°...', 'Loading...'],
		checking: ['ÐŸÑ€Ð¾Ð²ÐµÑ€ÐºÐ°...', 'Checking...'],
		deleting: ['Ð£Ð´Ð°Ð»ÐµÐ½Ð¸Ðµ...', 'Deleting...'],
		deletion: ['Ð£Ð´Ð°Ð»ÐµÐ½Ð¸Ðµ...', 'Deletion...'],
		updating: ['ÐžÐ±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ...', 'Updating...'],
		error: ['ÐžÑˆÐ¸Ð±ÐºÐ°', 'Error'],
		noConnect: ['ÐžÑˆÐ¸Ð±ÐºÐ° Ð¿Ð¾Ð´ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ñ', 'Connection failed'],
		internalError: ['Ð’Ð½ÑƒÑ‚Ñ€ÐµÐ½Ð½ÑÑ Ð¾ÑˆÐ¸Ð±ÐºÐ°:\n', 'Internal error:\n'],
		thrNotFound: ['Ð¢Ñ€ÐµÐ´ Ð½ÐµÐ´Ð¾ÑÑ‚ÑƒÐ¿ÐµÐ½ (â„–', 'Thread is unavailable (â„–'],
		thrClosed: ['Ð¢Ñ€ÐµÐ´ Ð·Ð°ÐºÑ€Ñ‹Ñ‚', 'Thread is closed'],
		thrArchived: ['Ð¢Ñ€ÐµÐ´ Ð² Ð°Ñ€Ñ…Ð¸Ð²Ðµ', 'Thread is archived'],
		succDeleted: ['Ð£ÑÐ¿ÐµÑˆÐ½Ð¾ ÑƒÐ´Ð°Ð»ÐµÐ½Ð¾!', 'Succesfully deleted!'],
		errDelete: ['ÐÐµ Ð¼Ð¾Ð³Ñƒ ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ:\n', 'Can\'t delete:\n'],
		cTimeError: ['ÐÐµÐ¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ñ‹Ðµ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ Ð²Ñ€ÐµÐ¼ÐµÐ½Ð¸', 'Invalid time settings'],
		noGlobalCfg: ['Ð“Ð»Ð¾Ð±Ð°Ð»ÑŒÐ½Ñ‹Ðµ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ Ð½Ðµ Ð½Ð°Ð¹Ð´ÐµÐ½Ñ‹', 'Global config not found'],
		postNotFound: ['ÐŸÐ¾ÑÑ‚ Ð½Ðµ Ð½Ð°Ð¹Ð´ÐµÐ½', 'Post not found'],
		dontShow: ['Ð¡ÐºÑ€Ñ‹Ñ‚ÑŒ: ', 'Hide: '],
		checkNow: ['ÐŸÑ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ ÑÐµÐ¹Ñ‡Ð°Ñ', 'Check now'],
		updAvail: ['Ð”Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð¾ Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ!', 'Update available!'],
		haveLatest: ['Ð£ Ð²Ð°Ñ ÑÑ‚Ð¾Ð¸Ñ‚ Ð¿Ð¾ÑÐ»ÐµÐ´Ð½ÑÑ ÑÑ‚Ð°Ð±Ð¸Ð»ÑŒÐ½Ð°Ñ Ð²ÐµÑ€ÑÐ¸Ñ!', 'You have the latest stable version!'],
		thrViewed: ['Ð¢Ñ€ÐµÐ´Ð¾Ð² Ð¿Ð¾ÑÐµÑ‰ÐµÐ½Ð¾', 'Threads visited'],
		thrCreated: ['Ð¢Ñ€ÐµÐ´Ð¾Ð² ÑÐ¾Ð·Ð´Ð°Ð½Ð¾', 'Threads created'],
		thrHidden: ['Ð¢Ñ€ÐµÐ´Ð¾Ð² ÑÐºÑ€Ñ‹Ñ‚Ð¾', 'Threads hidden'],
		postsSent: ['ÐŸÐ¾ÑÑ‚Ð¾Ð² Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¾', 'Posts sent'],
		total: ['Ð’ÑÐµÐ³Ð¾', 'Total'],
		debug: ['ÐžÑ‚Ð»Ð°Ð´ÐºÐ°', 'Debug'],
		infoDebug: ['Ð˜Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ Ð´Ð»Ñ Ð¾Ñ‚Ð»Ð°Ð´ÐºÐ¸', 'Information for debugging'],
		fileImpExp: ['Ð˜Ð¼Ð¿Ð¾Ñ€Ñ‚/ÑÐºÑÐ¿Ð¾Ñ€Ñ‚ Ð½Ð°ÑÑ‚Ñ€Ð¾ÐµÐº Ð² Ñ„Ð°Ð¹Ð»', 'Import/export config to file'],
		cfgImpExp: ['Ð˜Ð¼Ð¿Ð¾Ñ€Ñ‚/ÑÐºÑÐ¿Ð¾Ñ€Ñ‚ Ð½Ð°ÑÑ‚Ñ€Ð¾ÐµÐº', 'Import/export of config'],
		fileToData: ['Ð—Ð°Ð³Ñ€ÑƒÐ·Ð¸Ñ‚ÑŒ Ð´Ð°Ð½Ð½Ñ‹Ðµ Ð¸Ð· Ñ„Ð°Ð¹Ð»Ð°', 'Load data from a file'],
		dataToFile: ['ÐŸÐ¾Ð»ÑƒÑ‡Ð¸Ñ‚ÑŒ Ñ„Ð°Ð¹Ð»</a> Ñ Ð´Ð°Ð½Ð½Ñ‹Ð¼Ð¸', 'Get the file</a> with data'],
		globalCfg: ['Ð“Ð»Ð¾Ð±Ð°Ð»ÑŒÐ½Ñ‹Ðµ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸', 'Global config'],
		loadGlobal: ['Ð¸ Ð¿Ñ€Ð¸Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ðº ÑÑ‚Ð¾Ð¼Ñƒ Ð´Ð¾Ð¼ÐµÐ½Ñƒ', 'and apply to this domain'],
		saveGlobal: ['Ñ‚ÐµÐºÑƒÑ‰Ð¸Ðµ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ ÐºÐ°Ðº Ð³Ð»Ð¾Ð±Ð°Ð»ÑŒÐ½Ñ‹Ðµ', 'current config as global'],
		descrGlobal: ['Ð“Ð»Ð¾Ð±Ð°Ð»ÑŒÐ½Ñ‹Ðµ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ Ð¿Ñ€Ð¸Ð¼ÐµÐ½ÑÑŽÑ‚ÑÑ Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ<br>Ð¿Ñ€Ð¸ Ð¿ÐµÑ€Ð²Ð¾Ð¼ Ð¿Ð¾ÑÐµÑ‰ÐµÐ½Ð¸Ð¸ Ð´Ñ€ÑƒÐ³Ð¸Ñ… Ð´Ð¾Ð¼ÐµÐ½Ð¾Ð²', 'Global config is applied by default<br>on the first visit of other domains'],
		editInTxt: ['ÐŸÑ€Ð°Ð²ÐºÐ° Ð² Ñ‚ÐµÐºÑÑ‚Ð¾Ð²Ð¾Ð¼ Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚Ðµ', 'Edit in text format'],
		resetCfg: ['Ð¡Ð±Ñ€Ð¾ÑÐ¸Ñ‚ÑŒ Ð² Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ', 'Reset config to defaults'],
		resetData: ['ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ Ð´Ð°Ð½Ð½Ñ‹Ðµ', 'Reset selected data'],
		allDomains: ['Ð´Ð»Ñ Ð²ÑÐµÑ… Ð´Ð¾Ð¼ÐµÐ½Ð¾Ð²', 'for all domains'],
		delEntries: ['Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð¸ ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ Ð·Ð°Ð¿Ð¸ÑÐ¸', 'Select and delete entries'],
		saveChanges: ['Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ð²Ð½ÐµÑÐµÐ½Ð½Ñ‹Ðµ Ð¸Ð·Ð¼ÐµÐ½ÐµÐ½Ð¸Ñ', 'Save your changes'],
		infoCount: ['ÐžÐ±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ ÑÑ‡ÐµÑ‚Ñ‡Ð¸ÐºÐ¸ Ð¿Ð¾ÑÑ‚Ð¾Ð²', 'Refresh posts counters'],
		infoPage: ['ÐŸÑ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ Ð¿Ð¾Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ Ñ‚Ñ€ÐµÐ´Ð¾Ð² (Ð´Ð¾ 10-Ð¹ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹)', 'Check for threads position (up to 10th page)'],
		clrDeleted: ['ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ Ð½ÐµÐ´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ñ‹Ðµ (404) Ñ‚Ñ€ÐµÐ´Ñ‹', 'Clear inaccessible (404) threads'],
		oldPosts: ['ÐŸÐ¾ÑÑ‚Ð¾Ð² Ð¿Ñ€Ð¸ Ð¿Ð¾ÑÐ»ÐµÐ´Ð½ÐµÐ¼ Ð¿Ð¾ÑÐµÑ‰ÐµÐ½Ð¸Ð¸', 'Posts at the last visit'],
		myPostsRep: ['ÐžÑ‚Ð²ÐµÑ‚Ð¾Ð² Ð½Ð° Ð²Ð°ÑˆÐ¸ Ð¿Ð¾ÑÑ‚Ñ‹', 'Replies to your posts'],
		newPosts: ['ÐšÐ¾Ð»Ð¸Ñ‡ÐµÑÑ‚Ð²Ð¾ Ð½Ð¾Ð²Ñ‹Ñ… Ð¿Ð¾ÑÑ‚Ð¾Ð²', 'Number of new posts'],
		thrPage: ['Ð¢Ñ€ÐµÐ´ Ð½Ð° @ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ðµ', 'Thread on @page'],
		hiddenPosts: ['Ð¡ÐºÑ€Ñ‹Ñ‚Ñ‹Ðµ Ð¿Ð¾ÑÑ‚Ñ‹', 'Hidden posts'],
		onPage: [' Ð½Ð° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ðµ', ' on the page'],
		hidPostThr: ['Ð¡ÐºÑ€Ñ‹Ñ‚Ñ‹Ðµ Ð¿Ð¾ÑÑ‚Ñ‹ Ð¸ Ñ‚Ñ€ÐµÐ´Ñ‹', 'Hidden posts and threads'],
		myPosts: ['ÐœÐ¾Ð¸ Ð¿Ð¾ÑÑ‚Ñ‹', 'My posts'],
		noHidThr: ['ÐÐµÑ‚ ÑÐºÑ€Ñ‹Ñ‚Ñ‹Ñ… Ñ‚Ñ€ÐµÐ´Ð¾Ð²...', 'No hidden threads...'],
		invalidData: ['ÐÐµÐºÐ¾Ñ€Ñ€ÐµÐºÑ‚Ð½Ñ‹Ð¹ Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚ Ð´Ð°Ð½Ð½Ñ‹Ñ…', 'Incorrect data format'],
		noFavThr: ['ÐÐµÑ‚ Ð¸Ð·Ð±Ñ€Ð°Ð½Ð½Ñ‹Ñ… Ñ‚Ñ€ÐµÐ´Ð¾Ð²...', 'Favorites is empty...'],
		noVideoLinks: ['ÐÐµÑ‚ ÑÑÑ‹Ð»Ð¾Ðº Ð½Ð° Ð²Ð¸Ð´ÐµÐ¾...', 'No video links...'],
		hideLnkList: ['Ð¡ÐºÑ€Ñ‹Ñ‚ÑŒ/ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ ÑÐ¿Ð¸ÑÐ¾Ðº ÑÑÑ‹Ð»Ð¾Ðº', 'Hide/Unhide list of links'],
		prevVideo: ['ÐŸÑ€ÐµÐ´Ñ‹Ð´ÑƒÑ‰ÐµÐµ Ð²Ð¸Ð´ÐµÐ¾', 'Previous video'],
		nextVideo: ['Ð¡Ð»ÐµÐ´ÑƒÑŽÑ‰ÐµÐµ Ð²Ð¸Ð´ÐµÐ¾', 'Next video'],
		toPanel: ['Ð—Ð°ÐºÑ€ÐµÐ¿Ð¸Ñ‚ÑŒ Ð½Ð° Ð¿Ð°Ð½ÐµÐ»Ð¸', 'Attach to panel'],
		underPost: ['ÐŸÐ¾Ð¼ÐµÑÑ‚Ð¸Ñ‚ÑŒ Ñ„Ð¾Ñ€Ð¼Ñƒ Ð¿Ð¾Ð´ Ð¿Ð¾ÑÑ‚', 'Move form under post'],
		clearForm: ['ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ Ñ„Ð¾Ñ€Ð¼Ñƒ', 'Clear form'],
		makeDrag: ['Ð¡Ð´ÐµÐ»Ð°Ñ‚ÑŒ Ð¿ÐµÑ€ÐµÑ‚Ð°ÑÐºÐ¸Ð²Ð°ÐµÐ¼Ñ‹Ð¼ Ð¾ÐºÐ½Ð¾Ð¼', 'Make draggable window'],
		closeWindow: ['Ð—Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ Ð¾ÐºÐ½Ð¾', 'Close window'],
		closeReply: ['Ð—Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ Ñ„Ð¾Ñ€Ð¼Ñƒ', 'Close form'],
		replies: ['ÐžÑ‚Ð²ÐµÑ‚Ñ‹:', 'Replies:'],
		postsOmitted: ['ÐŸÑ€Ð¾Ð¿ÑƒÑ‰ÐµÐ½Ð¾ Ð¾Ñ‚Ð²ÐµÑ‚Ð¾Ð²: ', 'Posts omitted: '],
		showPosts: ['ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð¿Ð¾ÑÑ‚Ñ‹', 'Show posts'],
		hidePosts: ['Ð¡ÐºÑ€Ñ‹Ñ‚ÑŒ Ð¿Ð¾ÑÑ‚Ñ‹', 'Hide posts'],
		collapseThr: ['Ð¡Ð²ÐµÑ€Ð½ÑƒÑ‚ÑŒ Ñ‚Ñ€ÐµÐ´', 'Collapse thread'],
		deleted: ['ÑƒÐ´Ð°Ð»Ñ‘Ð½', 'deleted'],
		getNewPosts: ['ÐŸÐ¾Ð»ÑƒÑ‡Ð¸Ñ‚ÑŒ Ð½Ð¾Ð²Ñ‹Ðµ Ð¿Ð¾ÑÑ‚Ñ‹', 'Buscar nuevo post'],
		page: ['Ð¡Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°', 'Page'],
		hiddenThr: ['Ð¡ÐºÑ€Ñ‹Ñ‚Ñ‹Ð¹ Ñ‚Ñ€ÐµÐ´', 'Hidden thread'],
		makeThr: ['Ð¡Ð¾Ð·Ð´Ð°Ñ‚ÑŒ Ñ‚Ñ€ÐµÐ´', 'Crear un Tema'],
		makeReply: ['ÐžÑ‚Ð²ÐµÑ‚Ð¸Ñ‚ÑŒ', 'Contestar'],
		noSage: ['Ð‘ÐµÐ· ÑÐ°Ð¶Ð¸', 'No sage'],
		hideForm: ['Ð¡ÐºÑ€Ñ‹Ñ‚ÑŒ Ñ„Ð¾Ñ€Ð¼Ñƒ', 'Ocultar Formulario'],
		search: ['Ð˜ÑÐºÐ°Ñ‚ÑŒ Ð² ', 'Search in '],
		wait: ['Ð–Ð´Ð¸Ñ‚Ðµ', 'Wait'],
		dropFileHere: ['Ð‘Ñ€Ð¾ÑÑŒÑ‚Ðµ ÑÑŽÐ´Ð° Ñ„Ð°Ð¹Ð»(Ñ‹) Ð¸Ð»Ð¸ ÑÑÑ‹Ð»ÐºÑƒ', 'Drop file(s) or link here'],
		youCanDrag: ['ÐœÐ¾Ð¶Ð½Ð¾ Ð¿ÐµÑ€ÐµÑ‚Ð°ÑÐºÐ¸Ð²Ð°Ñ‚ÑŒ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸ Ð¸ ÑÑÑ‹Ð»ÐºÐ¸ Ð½Ð° Ñ„Ð°Ð¹Ð»Ñ‹&#13;Ð¿Ñ€ÑÐ¼Ð¾ ÑÐ¾ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹ Ð¸Ð»Ð¸ Ð´Ñ€ÑƒÐ³Ð¸Ñ… ÑÐ°Ð¹Ñ‚Ð¾Ð²', 'You can drag images and file links&#13;directly from the page or other sites'],
		removeFile: ['Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ Ñ„Ð°Ð¹Ð»', 'Remove file'],
		spoilFile: ['Ð¡Ð¿Ð¾Ð¹Ð»ÐµÑ€', 'Spoiler'],
		addManually: ['Ð’Ð²ÐµÑÑ‚Ð¸ ÑÑÑ‹Ð»ÐºÑƒ Ð½Ð° Ñ„Ð°Ð¹Ð» Ð²Ñ€ÑƒÑ‡Ð½ÑƒÑŽ', 'Enter a link to the file manually'],
		enterTheLink: ['Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ ÑÑÑ‹Ð»ÐºÑƒ Ð¸ Ð½Ð°Ð¶Ð¼Ð¸Ñ‚Ðµ \'+\'', 'Enter the link and click \'+\''],
		helpAddFile: ['Ð’ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÑŒ ogg/rar/zip/7z Ð² ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÑƒ', 'Embed ogg/rar/zip/7z into the image'],
		downloadFile: ['Ð¡ÐºÐ°Ñ‡Ð°Ñ‚ÑŒ ÑÐ¾Ð´ÐµÑ€Ð¶Ð°Ñ‰Ð¸Ð¹ÑÑ Ð² ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐµ Ñ„Ð°Ð¹Ð»', 'Download embedded file from the image'],
		fileCorrupt: ['Ð¤Ð°Ð¹Ð» Ð¿Ð¾Ð²Ñ€ÐµÐ¶Ð´Ñ‘Ð½: ', 'File is corrupt: '],
		subjHasTrip: ['ÐŸÐ¾Ð»Ðµ "Ð¢ÐµÐ¼Ð°" ÑÐ¾Ð´ÐµÑ€Ð¶Ð¸Ñ‚ Ñ‚Ñ€Ð¸Ð¿ÐºÐ¾Ð´', '"Subject" field contains a tripcode'],
		loadImage: ['Ð—Ð°Ð³Ñ€ÑƒÐ¶Ð°ÑŽÑ‚ÑÑ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ¸: ', 'Loading images: '],
		loadFile: ['Ð—Ð°Ð³Ñ€ÑƒÐ¶Ð°ÑŽÑ‚ÑÑ Ñ„Ð°Ð¹Ð»Ñ‹: ', 'Loading files: '],
		cantLoad: ['ÐÐµ Ð¼Ð¾Ð³Ñƒ Ð·Ð°Ð³Ñ€ÑƒÐ·Ð¸Ñ‚ÑŒ ', 'Can\'t load '],
		willSavePview: ['Ð‘ÑƒÐ´ÐµÑ‚ ÑÐ¾Ñ…Ñ€Ð°Ð½ÐµÐ½Ð¾ Ð¿Ñ€ÐµÐ²ÑŒÑŽ', 'Thumbnail will be saved'],
		loadErrors: ['Ð’Ð¾ Ð²Ñ€ÐµÐ¼Ñ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ¸ Ð¿Ñ€Ð¾Ð¸Ð·Ð¾ÑˆÐ»Ð¸ Ð¾ÑˆÐ¸Ð±ÐºÐ¸:', 'An error occurred during the loading:'],
		errCorruptData: ['ÐžÑˆÐ¸Ð±ÐºÐ°: ÑÐµÑ€Ð²ÐµÑ€ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð¸Ð» Ð¿Ð¾Ð²Ñ€ÐµÐ¶Ð´Ñ‘Ð½Ð½Ñ‹Ðµ Ð´Ð°Ð½Ð½Ñ‹Ðµ', 'Error: server sent corrupted data'],
		errMsEdgeWebm: ['Ð—Ð°Ð³Ñ€ÑƒÐ·Ð¸Ñ‚Ðµ ÑÐºÑ€Ð¸Ð¿Ñ‚ Ð´Ð»Ñ Ð²Ð¾ÑÐ¿Ñ€Ð¾Ð¸Ð·Ð²ÐµÐ´ÐµÐ½Ð¸Ñ WebM (VP9/Opus)', 'Please load a script to play WebM (VP9/Opus)'],
		expImgInline: ['[Click] Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚ÑŒ Ð² Ð¿Ð¾ÑÑ‚Ðµ, [Ctrl+Click] Ð² Ñ†ÐµÐ½Ñ‚Ñ€Ðµ', '[Click] expand in post, [Ctrl+Click] by center'],
		expImgFull: ['[Click] Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚ÑŒ Ð² Ñ†ÐµÐ½Ñ‚Ñ€Ðµ, [Ctrl+Click] Ð² Ð¿Ð¾ÑÑ‚Ðµ', '[Click] expand by center, [Ctrl+Click] in post'],
		nextImg: ['Ð¡Ð»ÐµÐ´ÑƒÑŽÑ‰Ð°Ñ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ°', 'Next image'],
		prevImg: ['ÐŸÑ€ÐµÐ´Ñ‹Ð´ÑƒÑ‰Ð°Ñ ÐºÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ°', 'Previous image'],
		togglePost: ['Ð¡ÐºÑ€Ñ‹Ñ‚ÑŒ/Ð Ð°ÑÐºÑ€Ñ‹Ñ‚ÑŒ Ð¿Ð¾ÑÑ‚', 'Hide/Unhide post'],
		replyToPost: ['ÐžÑ‚Ð²ÐµÑ‚Ð¸Ñ‚ÑŒ Ð½Ð° Ð¿Ð¾ÑÑ‚', 'Responder el post'],
		expandThr: ['Ð Ð°Ð·Ð²ÐµÑ€Ð½ÑƒÑ‚ÑŒ Ñ‚Ñ€ÐµÐ´', 'Expand thread'],
		addFav: ['Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ñ‚Ñ€ÐµÐ´ Ð² Ð˜Ð·Ð±Ñ€Ð°Ð½Ð½Ð¾Ðµ', 'Add thread to Favorites'],
		delFav: ['Ð£Ð±Ñ€Ð°Ñ‚ÑŒ Ñ‚Ñ€ÐµÐ´ Ð¸Ð· Ð˜Ð·Ð±Ñ€Ð°Ð½Ð½Ð¾Ð³Ð¾', 'Remove thread from Favorites'],
		attachPview: ['Ð—Ð°ÐºÑ€ÐµÐ¿Ð¸Ñ‚ÑŒ Ð¿Ñ€ÐµÐ²ÑŒÑŽ', 'Attach preview'],
		expandVideo: ['Ð Ð°Ð·Ð²ÐµÑ€Ð½ÑƒÑ‚ÑŒ/Ð¡Ð²ÐµÑ€Ð½ÑƒÑ‚ÑŒ Ð²Ð¸Ð´ÐµÐ¾', 'Expand/Collapse video'],
		duration: ['ÐŸÑ€Ð¾Ð´Ð¾Ð»Ð¶Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾ÑÑ‚ÑŒ: ', 'Duration: '],
		published: ['Ð¾Ð¿ÑƒÐ±Ð»Ð¸ÐºÐ¾Ð²Ð°Ð½Ð¾: ', 'published: '],
		author: ['ÐÐ²Ñ‚Ð¾Ñ€: ', 'Author: '],
		views: ['Ð¿Ñ€Ð¾ÑÐ¼Ð¾Ñ‚Ñ€Ð¾Ð²: ', 'views: '],

		seSyntaxErr: ['ÑÐ¸Ð½Ñ‚Ð°ÐºÑÐ¸Ñ‡ÐµÑÐºÐ°Ñ Ð¾ÑˆÐ¸Ð±ÐºÐ° Ð² Ð°Ñ€Ð³ÑƒÐ¼ÐµÐ½Ñ‚Ðµ ÑÐ¿ÐµÐ»Ð»Ð°: %s', 'syntax error in argument of spell: %s'],
		seUnknown: ['Ð½ÐµÐ¸Ð·Ð²ÐµÑÑ‚Ð½Ñ‹Ð¹ ÑÐ¿ÐµÐ»Ð»: %s', 'unknown spell: %s'],
		seMissOp: ['Ð¿Ñ€Ð¾Ð¿ÑƒÑ‰ÐµÐ½ Ð¾Ð¿ÐµÑ€Ð°Ñ‚Ð¾Ñ€', 'missing operator'],
		seMissArg: ['Ð¿Ñ€Ð¾Ð¿ÑƒÑ‰ÐµÐ½ Ð°Ñ€Ð³ÑƒÐ¼ÐµÐ½Ñ‚ ÑÐ¿ÐµÐ»Ð»Ð°: %s', 'missing argument of spell: %s'],
		seMissSpell: ['Ð¿Ñ€Ð¾Ð¿ÑƒÑ‰ÐµÐ½ ÑÐ¿ÐµÐ»Ð»', 'missing spell'],
		seErrRegex: ['ÑÐ¸Ð½Ñ‚Ð°ÐºÑÐ¸Ñ‡ÐµÑÐºÐ°Ñ Ð¾ÑˆÐ¸Ð±ÐºÐ° Ð² Ñ€ÐµÐ³ÑƒÐ»ÑÑ€Ð½Ð¾Ð¼ Ð²Ñ‹Ñ€Ð°Ð¶ÐµÐ½Ð¸Ð¸: %s', 'syntax error in regular expression: %s'],
		seUnexpChar: ['Ð½ÐµÐ¾Ð¶Ð¸Ð´Ð°Ð½Ð½Ñ‹Ð¹ ÑÐ¸Ð¼Ð²Ð¾Ð»: %s', 'unexpected character: %s'],
		seMissClBkt: ['Ð¿Ñ€Ð¾Ð¿ÑƒÑ‰ÐµÐ½Ð° Ð·Ð°ÐºÑ€Ñ‹Ð²Ð°ÑŽÑ‰Ð°Ñ ÑÐºÐ¾Ð±ÐºÐ°', 'missing \')\' in expression'],
		seRepsInParens: ['ÑÐ¿ÐµÐ»Ð» %s Ð½Ðµ Ð´Ð¾Ð»Ð¶ÐµÐ½ Ñ€Ð°ÑÐ¿Ð¾Ð»Ð°Ð³Ð°Ñ‚ÑŒÑÑ Ð² ÑÐºÐ¾Ð±ÐºÐ°Ñ…', 'spell %s shouldn\'t be inside parentheses'],
		seOpInReps: ['Ð½ÐµÐ´Ð¾Ð¿ÑƒÑÑ‚Ð¸Ð¼Ð¾ Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÑŒ Ð¾Ð¿ÐµÑ€Ð°Ñ‚Ð¾Ñ€ %s ÑÐ¾ ÑÐ¿ÐµÐ»Ð»Ð°Ð¼Ð¸ #rep Ð¸ #outrep', 'don\'t use operator %s with spells #rep & #outrep'],
		seRow: [' (ÑÑ‚Ñ€Ð¾ÐºÐ° ', ' (row '],
		seCol: [', ÑÑ‚Ð¾Ð»Ð±ÐµÑ† ', ', column '],
		sendingPost: ['ÐžÑ‚Ð¿Ñ€Ð°Ð²ÐºÐ° Ð¿Ð¾ÑÑ‚Ð°...', 'Sending post...'],
		sizeByte: [' Ð‘Ð°Ð¹Ñ‚', ' Byte'],
		sizeKByte: [' ÐšÐ‘', ' KB'],
		sizeMByte: [' ÐœÐ‘', ' MB'],
		sizeGByte: [' Ð“Ð‘', ' GB'],
		second: ['Ñ', 's']
					...
					switch (_this16.pattern[i]) {
						...
						case 'm':
							switch (a.slice(0, 3).toLowerCase()) {
								...
								case 'Ð°Ð¿Ñ€':case 'apr':
									month = 3;break;
								case 'Ð¼Ð°Ð¹':case 'Ð¼Ð°Ñ':case 'may':
									month = 4;break;
								case 'Ð¸ÑŽÐ½':case 'jun':
									month = 5;break;
								case 'Ð¸ÑŽÐ»':case 'jul':
...
true, true],
	...
	function getSubmitError(dc) {
		...
		return (/successful|uploaded|updating|post deleted|Ð¾Ð±Ð½Ð¾Ð²Ð»|ÑƒÐ´Ð°Ð»ÐµÐ½[Ð¾\.]/i.test(err) ? null : err
		);
	}
			...
			value: function handleEvent(e) {
				switch (e.type) {
					case 'keypress':
						...
						var ruUa = 'Ð¹Ñ†ÑƒÐºÐµÐ½Ð³ÑˆÑ‰Ð·Ñ…ÑŠÑ—Ñ„Ñ‹Ñ–Ð²Ð°Ð¿Ñ€Ð¾Ð»Ð´Ð¶ÑÑ”ÑÑ‡ÑÐ¼Ð¸Ñ‚ÑŒÐ±ÑŽÑ‘Ò‘';
		...
		_createClass(AbstractPost, [{
						...
						case 'A':
							...
							if ((temp = el.firstElementChild) && temp.tagName === 'IMG') {
								...
								if (temp === this.trunc) {
									...
									$pd(e);
									e.stopPropagation();
								} else if (Cfg.insertNum && pr.form && (aib.tiny ? el : temp) === this._pref && !/Reply|ÐžÑ‚Ð²ÐµÑ‚/.test(el.textContent)) {
									$pd(e);
									e.stopPropagation();
									if (!Cfg.showRepBtn) {
										quotetxt = window.getSelection().toString();
			...
			get: function get() {
				var el = aib.qTrunc && $q(aib.qTrunc, this.el),
				    value = null;
				if (el && /long|full comment|gekÃ¼rzt|ÑÐ»Ð¸ÑˆÐºÐ¾Ð¼|Ð´Ð»Ð¸Ð½Ð½|Ð¼Ð½Ð¾Ð³|Ð¿Ð¾Ð»Ð½/i.test(el.textContent)) {
					value = el;
				}
		...
		_createClass(MakabaPostsBuilder, [{
				...
				return regeneratorRuntime.wrap(function bannedPostsData$(_context21) {
					while (1) {
						switch (_context21.prev = _context21.next) {
							...
							case 15:
								_context21.next = 17;
								return [1, _post4.num, $add('<span class="pomyanem">(ÐÐ²Ñ‚Ð¾Ñ€ ÑÑ‚Ð¾Ð³Ð¾ Ð¿Ð¾ÑÑ‚Ð° Ð±Ñ‹Ð» Ð·Ð°Ð±Ð°Ð½ÐµÐ½. ÐŸÐ¾Ð¼ÑÐ½ÐµÐ¼.)</span>')];
							...
							case 18:
								_context21.next = 20;
								return [2, _post4.num, $add('<span class="pomyanem">(ÐÐ²Ñ‚Ð¾Ñ€ ÑÑ‚Ð¾Ð³Ð¾ Ð¿Ð¾ÑÑ‚Ð° Ð±Ñ‹Ð» Ð¿Ñ€ÐµÐ´ÑƒÐ¿Ñ€ÐµÐ¶Ð´ÐµÐ½.)</span>')];
			...
			value: function _getPostMsg(data) {
				...
				return '<blockquote id="m' + data.num + '" class="post-message">\n\t\t\t' + comment + '\n\t\t\t' + _switch(data.banned, {
					1: '<br><span class="pomyanem">(ÐÐ²Ñ‚Ð¾Ñ€ ÑÑ‚Ð¾Ð³Ð¾ Ð¿Ð¾ÑÑ‚Ð° Ð±Ñ‹Ð» Ð·Ð°Ð±Ð°Ð½ÐµÐ½. ÐŸÐ¾Ð¼ÑÐ½ÐµÐ¼.)</span>',
					2: '<br><span class="pomyanem">(ÐÐ²Ñ‚Ð¾Ñ€ ÑÑ‚Ð¾Ð³Ð¾ Ð¿Ð¾ÑÑ‚Ð° Ð±Ñ‹Ð» Ð¿Ñ€ÐµÐ´ÑƒÐ¿Ñ€ÐµÐ¶Ð´ÐµÐ½.)</span>',
					'@@default': ''
				}) + '\n\t\t</blockquote>';
			}
		}, {
	...
	var BaseBoard = function () {
		...
		_createClass(BaseBoard, [{
			...
			key: 'markupTags',
			get: function get() {
				return this.markupBB ? ['b', 'i', 'u', 's', 'spoiler', 'code'] : ['[b', '[i', '[u', '[s', '[spoiler', '[c'];
		...
		var Makaba = function (_BaseBoard) {
			...
			_createClass(Makaba, [{
				...
				value: function getBanId(postEl) {
					...
					return el.textContent.includes('Ð¿Ñ€ÐµÐ´ÑƒÐ¿Ñ€ÐµÐ¶Ð´ÐµÐ½') ? 2 : 1;
				}
			}, {
				key: 'getImgWrap',
				value: function getImgWrap(img) {
				...
				value: function updateCaptcha(cap, isErr) {
					...
					return cap.updateHelper('/api/captcha/' + type + '/id?board=' + this.b + '&thread=' + pr.tNum, function (xhr) {
						...
						switch (data.result) {
							case 0:
								box.innerHTML = 'ÐŸÐ°ÑÑ-ÐºÐ¾Ð´ Ð½Ðµ Ð´ÐµÐ¹ÑÑ‚Ð²Ð¸Ñ‚ÐµÐ»ÐµÐ½. <a href="#" id="renew-pass-btn">ÐžÐ±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ</a>';
								break;
							case 2:
								box.textContent = 'Ð’Ð°Ð¼ Ð½Ðµ Ð½ÑƒÐ¶Ð½Ð¾ Ð²Ð²Ð¾Ð´Ð¸Ñ‚ÑŒ ÐºÐ°Ð¿Ñ‡Ñƒ, Ñƒ Ð²Ð°Ñ Ð²Ð²ÐµÐ´ÐµÐ½ Ð¿Ð°ÑÑ-ÐºÐ¾Ð´.';
								break;
							case 3:
			...
			_createClass(_2chRip, [{
				...
				value: function init() {
					...
					if (el) {
						...
						$replace(el, '<input type="submit" id="submit" name="submit" value="ÐžÑ‚Ð²ÐµÑ‚">');
					}
					return false;
				}
			}, {
		...
		var _2chRu = function (_BaseBoard9) {
			...
			_createClass(_2chRu, [{
				...
				value: function init() {
					...
					if (el) {
						$replace(el, '<input type="submit" value="ÐžÑ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ">');
					}
					el = $q(this.qDForm);
			...
			_createClass(Dobrochan, [{
				...
				value: function updateCaptcha(cap, isErr) {
					...
					if (cap.textEl) {
						...
						img.insertAdjacentHTML('afterend', '<br><input placeholder="ÐšÐ°Ð¿Ñ‡Ð°" autocomplete="off"' + ' id="captcha" name="captcha" size="35" type="text">');
						$show(img);
						cap.isAdded = false;
